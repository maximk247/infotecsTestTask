...
describe('UserSearch', () => {
  ...
  test('renders input and select elements correctly', () => {
    const { getByPlaceholderText, getByDisplayValue } = render(
      <UserSearch searchTerm={searchTerm} searchKey={searchKey} onSearch={onSearch} onKeyChange={onKeyChange} />
    );
  ...
  test('calls onSearch with correct arguments when input value changes', () => {
    ...
    fireEvent.change(getByPlaceholderText('Search...'), { target: { value: 'Doe' } });
  ...
  test('calls onKeyChange with correct arguments when select value changes', () => {
    ...
    fireEvent.change(getByDisplayValue('Имя'), { target: { value: 'firstName' } });
